...
urlpatterns = [
    ...
    # Phase 7 exports
    path("<int:pk>/time-report.csv", views.TimeReportView.as_view(), name="project-time-report"),
    path("<int:pk>/irr-export.csv", views.IRRExportView.as_view(), name="project-irr-export"),
    ...
    path("<int:pk>/import-ris/", views.RISImportView.as_view(), name="project-import-ris"),
    path(
        "<int:pk>/import-ris-bundle/",
        views.RISBundleImportView.as_view(),
        name="project-import-ris-bundle",
    ),
    path("<int:pk>/upload-pdf/", views.PDFUploadView.as_view(), name="project-upload-pdf"),
    path(
